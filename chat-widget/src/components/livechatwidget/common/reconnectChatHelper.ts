...
const getReconnectIdForAuthenticatedChat = async (props: ILiveChatWidgetProps, chatSDK: any) => {
    if (props.reconnectChatPaneProps?.isReconnectEnabled
        && props.authProps?.authClientFunction
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const handleUnauthenticatedReconnectChat = async (chatSDK: any, authProps: IAuthProps, dispatch: Dispatch<ILiveChatWidgetAction>, setAdapter: any, reconnectId: string, initStartChat: any, redirectInSameWindow: boolean | undefined) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const startUnauthenticatedReconnectChat = async (chatSDK: any, authProps: IAuthProps, dispatch: Dispatch<ILiveChatWidgetAction>, setAdapter: any, reconnectId: string, initStartChat: any) => {
    const reconnectAvailabilityResponse: IReconnectChatContext = await getChatReconnectContext(chatSDK, reconnectId);
    if (!shouldRedirectOrStartNewChat(reconnectAvailabilityResponse)) {
        await setReconnectIdAndStartChat(chatSDK, authProps, dispatch, setAdapter, reconnectId, initStartChat);
    }
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const setReconnectIdAndStartChat = async (chatSDK: any, authProps: IAuthProps, dispatch: Dispatch<ILiveChatWidgetAction>, setAdapter: any, reconnectId: string, initStartChat: any) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const startNewChatEmptyRedirectionUrl = async (chatSDK: any, authProps: IAuthProps, dispatch: Dispatch<ILiveChatWidgetAction>, setAdapter: any, initStartChat: any) => {
    const startUnauthenticatedReconnectChat: ICustomEvent = {
        eventName: BroadcastEvent.StartUnauthenticatedReconnectChat,
    };
    BroadcastService.postMessage(startUnauthenticatedReconnectChat);
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const handleRedirectUnauthenticatedReconnectChat = async (chatSDK: any, authProps: IAuthProps, dispatch: Dispatch<ILiveChatWidgetAction>, setAdapter: any, initStartChat: any, reconnectId: string, redirectInSameWindow: boolean | undefined) => {
    const reconnectAvailabilityResponse: IReconnectChatContext = await getChatReconnectContext(chatSDK, reconnectId);
    if (shouldRedirectOrStartNewChat(reconnectAvailabilityResponse)) {
        await redirectOrStartNewChat(reconnectAvailabilityResponse, chatSDK, authProps, dispatch, setAdapter, initStartChat, redirectInSameWindow);
    }
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const redirectOrStartNewChat = async (reconnectAvailabilityResponse: IReconnectChatContext, chatSDK: any, authProps: IAuthProps, dispatch: Dispatch<ILiveChatWidgetAction>, setAdapter: any, initStartChat: any, redirectInSameWindow: boolean | undefined) => {
